...
class Raycasting:
    ...
    def ray_cast(self):
        ...
        for ray in range(NUM_RAYS):
            ...
            # horizontals
            y_hor, dy = (y_map + 1, 1) if sin_a > 0 else (y_map - EPSILON, -1)
    ...
    def bfs(self, start, goal, graph):
        ...
        while queue:
            ...
            for next_node in next_nodes:
                node_not_visited = next_node not in visited
                node_not_position = next_node not in self.game.object_handler.npc_positions
                if node_not_visited and node_not_position:
